...
CREATE TABLE finance_rent (
  ...
  rentin_date DATETIME  COMMENT '承租时间',
  ...
  rentin_nextpaydate VARCHAR(2000)  COMMENT '承租下次付租日期',
  
  rentout_date VARCHAR(64)  COMMENT '出租时间',
  rentout_deposit VARCHAR(64)  COMMENT '出租押金',
  rentout_rentmonth VARCHAR(64)  COMMENT '出租月租金',
  rentout_lastpaysdate VARCHAR(64)  COMMENT '出租上次付款开始日期',
  rentout_lastpayedate VARCHAR(64)  COMMENT '出租上次付款结束日期',
  rentout_amountreceived VARCHAR(64)  COMMENT '出租已收金额',
  rentout_nextpaydate VARCHAR(64)  COMMENT '出租下次付租日期',
