...
<head>
	...
	<style type="text/css">
		...
		body {background: url(${ctxStatic}/images/login_bg.jpg) no-repeat center center fixed;}
		#title{color:white; font-size:25px; font-weight: bold; text-align: center; }
		.login-form label {font-size:14px;}
		.container{width:340px; margin-left: 580px; margin-top: 150px;}
...
<div id="title">${fns:getConfig('productName')}</div>
    <div class="container">
            ...
            <form id="loginForm"  class="form login-form" action="${ctx}/login" method="post">
                ...
                <div class="footer">
                    <label class="checkbox inline">
                        <input type="checkbox" id="rememberMe" name="rememberMe"> <span style="color:white;">记住我</span>
                    </label>
                    <input class="btn btn-primary" type="submit" value="登 录"/>
                </div>
				<div id="themeSwitch" class="dropdown pull-right">
					<a class="dropdown-toggle" style="color:white;" data-toggle="dropdown" href="#">${fns:getDictLabel(cookie.theme.value,'theme','默认主题')}<b class="caret"></b></a>
    ...
    <footer class="white navbar-fixed-bottom">
		Copyright &copy; 2012-${fns:getConfig('copyrightYear')} <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a> - Powered By sum_xiatian@163.com
    </footer>
  </body>
</html>