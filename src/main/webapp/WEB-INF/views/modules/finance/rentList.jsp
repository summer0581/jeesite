...
<body>
	...
	<form:form id="searchForm" modelAttribute="rent" action="${ctx}/finance/rent/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th>名称</th><th>备注</th><shiro:hasPermission name="finance:rent:edit"><th>操作</th></shiro:hasPermission></tr></thead>
		<tbody>
