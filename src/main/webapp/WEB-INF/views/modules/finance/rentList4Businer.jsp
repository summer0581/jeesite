...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
			$("#pageNo").val(n);
			$("#pageSize").val(s);
			$("#searchForm").attr("action","${ctx}/finance/rent/rentList4Businer");
			$("#searchForm").submit();
        	return false;
        }
		function resets(){
...
<body>
	...
	<form:form id="searchForm" modelAttribute="rent" action="${ctx}/finance/rent/rentList4Businer" method="post" class="breadcrumb form-search">
