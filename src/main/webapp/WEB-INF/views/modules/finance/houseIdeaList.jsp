...
<body>
	...
	<form:form id="searchForm" modelAttribute="houseIdea" action="${ctx}/finance/houseIdea/" method="post" class="breadcrumb form-search">
		...
		<label>跟进内容 ：</label><input id="content" name="content" type="text" maxlength="50" class=" " value="${paramMap.content}"/>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th style="width:62%;">跟进内容</th><th style="width:15%;">跟进房屋</th><th style="width:12%;">跟进人</th><th style="width:11%;">跟进时间</th><shiro:hasPermission name="finance:houseIdea:edit"><th>操作</th></shiro:hasPermission></tr></thead>
		<tbody>
		<c:forEach items="${page.list}" var="houseIdea">
			<tr>
				...
				<shiro:hasPermission name="finance:houseIdea:edit"><td>
    				<a href="${ctx}/finance/houseIdea/form?id=${houseIdea.id}">修改</a>
    				<shiro:hasPermission name="finance:houseIdea:delete">
					<a href="${ctx}/finance/houseIdea/delete?id=${houseIdea.id}" onclick="return confirmx('确认要删除该房屋跟进意见吗？', this.href)">删除</a>
					</shiro:hasPermission>
